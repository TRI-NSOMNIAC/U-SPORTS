...
class TournamentBracketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final canvasHeight = (maxMatchesInRound * 88.0 + 72).clamp(280.0, 720.0);
...
class _ParticipantRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: highlight ? AppTheme.success.withValues(alpha: 0.12) : const Color(0xFF16161E),
      ...
      child: Row(
        children: [
          ...
          if (highlight) const Icon(Icons.check, size: 16, color: AppTheme.success),
        ],
      ),
    );
  }
