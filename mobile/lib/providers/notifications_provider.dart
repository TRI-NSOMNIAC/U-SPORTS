...
/// Bell badge: exact unread count from [unreadNotificationsCountProvider] for students (verified) and athletes.
final studentNotificationBadgeCountProvider = Provider<int>((ref) {
  final profile = ref.watch(profileProvider).valueOrNull;
  if (profile == null) return 0;
  final eligible = (profile.isStudent && profile.enrollmentVerified) || profile.isAthlete;
