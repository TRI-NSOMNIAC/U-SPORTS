...
final eventListProvider = StreamProvider.family<List<Map<String, dynamic>>, Map<String, String?>>((ref, filters) {
  ...
  Future<void> load() async {
    try {
      ...
      if (filters['isTryout'] != null) q['isTryout'] = filters['isTryout']!;
...
final eventDetailProvider = StreamProvider.family<Map<String, dynamic>?, String>((ref, eventId) {
...
final bracketsForEventProvider = StreamProvider.family<List<Map<String, dynamic>>, String>((ref, eventId) {
  final ctrl = StreamController<List<Map<String, dynamic>>>();
...
final matchesForEventProvider = StreamProvider.family<List<Map<String, dynamic>>, String>((ref, eventId) {
  final ctrl = StreamController<List<Map<String, dynamic>>>();
  var loadSeq = 0;
...
final scoringStateProvider = StreamProvider.family<Map<String, dynamic>, String>((ref, matchId) {
  final ctrl = StreamController<Map<String, dynamic>>();
  var loadSeq = 0;
  var disposed = false;
