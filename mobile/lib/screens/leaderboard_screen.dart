  ...
  Widget build(BuildContext context) {
    ...
    final bottomIndex = loc.startsWith('/leaderboards')
        ...
        : loc.startsWith('/events')
            ? 2
            : (loc.startsWith('/student/profile') || loc.startsWith('/athlete/profile') || loc.startsWith('/auth/login'))
                ? 3
                : 0;
              ...
              children: [
                ...
                teams?.when(
                      ...
                      data: (rows) {
                        ...
                        if (rows.isEmpty) {
                          return const Center(child: Text('No team standings yet.', style: TextStyle(color: AppTheme.textMuted)));
                        }
                            ...
                            return Material(
                              ...
                              child: ListTile(
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    Text('$w W', style: const TextStyle(color: AppTheme.success, fontWeight: FontWeight.w700)),
        ...
        onTap: (i) {
          switch (i) {
            case 0:
              ...
              break;
            case 1:
              context.go('/leaderboards?sport=$_sport');
              break;
            case 2:
              context.go('/events');
              break;
