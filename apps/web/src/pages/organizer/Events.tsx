  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <button type="button" onClick={() => navigate('/organizer')} className="text-[var(--text-muted)] hover:text-white p-1 rounded" aria-label="Back to dashboard">
          ...
          {filtered.map(e => (
            <Card key={e.id} className="cursor-pointer hover:border-white/20 transition-colors" onClick={() => navigate(`/organizer/events/${e.id}`)}>
              ...
              <div className="flex items-center gap-2 flex-wrap mb-1">
                ...
                {e.is_tryout ? <Badge size="sm" variant="info">Tryout</Badge> : null}
