...
export function buildSeasonAggregateInsights(
  ...
  if (sport === 'basketball' && leaderboard.length > 0) {
    const qualifying = leaderboard.filter((p) => p.games_played >= 2)
    if (qualifying.length > 0) {
      ...
      if (top.games_played >= MIN_GP_PLAYER) {
        out.push({
          id: 'bb-ppg',
          tone: 'positive',
          parts: [
        ...
        out.push({
          ...
          parts: [
            ...
            {
              type: 'text',
              value: ` has the highest points-per-game among athletes with multiple logged games (${ppg} PPG).`,
            },
          ],
        })
      }
    ...
    if (iron && iron.games_played >= 5) {
      ...
      out.push({
        ...
        parts: [
          ...
          { type: 'text', value: ` has the busiest recorded schedule (${iron.games_played} GP).` },
        ],
      })
    }
    ...
    if (glass) {
      ...
      out.push({
        ...
        parts: [
          ...
          { type: 'text', value: ` is pacing the glass (${rpg} RPG over ${glass.games_played} GP).` },
        ],
      })
    }
  }
    ...
    if (qualifying.length > 0) {
      ...
      out.push({
        ...
        parts: [
          ...
          {
            type: 'text',
            value: ` has the most recorded kills (${byKills.stats?.kills ?? 0}) among multi-game athletes.`,
          },
        ],
      })
    }
    ...
    if (byEff) {
      ...
      out.push({
        ...
        parts: [
          ...
          {
            type: 'text',
            value: ` holds the strongest kill efficiency among regular contributors (${pct}% kill rate).`,
          },
        ],
      })
    }
    ...
    if (qualifying.length > 0) {
      ...
      out.push({
        ...
        parts: [
          ...
          { type: 'text', value: ` has the most recorded match wins (${byW.stats?.mw ?? 0}).` },
        ],
      })
    }
    ...
    if (byPct) {
      ...
      out.push({
        ...
        parts: [
          ...
          {
            type: 'text',
            value: ` owns the top recorded win percentage (${byPct.stats?.win_pct ?? 0}% across ${byPct.games_played} GP).`,
          },
        ],
      })
    }
  ...
  if (rankedTeams.length > 0) {
    ...
    out.push({
      ...
      parts: [
        ...
        {
          type: 'text',
          value: ` leads recorded team win rate (${Math.round(best.pct * 100)}% over ${best.gp} matches).`,
        },
      ],
    })
  }
  ...
  if (busiestTeam && busiestTeam.wins + busiestTeam.losses >= 6) {
