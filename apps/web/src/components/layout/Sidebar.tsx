...
const superAdminNav = [
  ...
  { to: '/organizer/reviews', label: 'Reviews', icon: UserCheck },
...
const studentNav = [
  { to: '/guest', label: 'Browse hub', icon: Globe, exact: false },
  { to: '/student/profile', label: 'My Profile', icon: User, exact: true },
  { to: '/student/settings', label: 'Settings', icon: Settings, exact: true },
]
